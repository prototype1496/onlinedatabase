...
$result = $admin_president_model->get_all_activated_users();
                                                            ...
                                                            <tr data-expanded="true">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>  <form method="post" action="../../Controller/PresidentAdmin/ActionPerformed.php">
                                                                            ...
                                                                            <button name="deactivated" vlaue="<?php echo $row['id']; ?>" class="btn btn-default"><i class="fa fa-compass"></i></button>
                                                                            <input name="deactivated_id" type="hidden" value="<?php echo $row['id']; ?>"/>
