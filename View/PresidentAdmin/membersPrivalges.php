...
$result = $admin_president_model->get_all_users();
                                                    ...
                                                    <table class="table table-hover table-responsive" ui-jq="footable" ui-options='{
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-breakpoints="xs">Appointment Date</th>
                                                                <th data-breakpoints="xs">Activated</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $row['activated']; ?></td>
                                                                         ...
                                                                         <td>
                                                                          ...
                                                                          <form method="post" action="../../Controller/PresidentAdmin/UpgradePrivilege.php"> 
                                                                        <select name ="user_role_id" class="custom-select ">
                                                                            <option value="<?php echo $row['rileid']; ?>" selected>Select Privilege</option>
                                                                    <?php  
                                                                    $get_user_rows = $admin_president_model->get_member_role();
                                                                    while ($rows = mysqli_fetch_array($get_user_rows)) {  ?>
                                                                       
                                                                                  
                                                            <option value="<?php echo $rows['rileid']; ?>"><?php echo $rows['name']; ?></option>
                                                                    ...
                                                                    ?>   
                                                                         ...
                                                                         <td>  
                                                                            ...
                                                                            <button name="view" vlaue="<?php echo $row['id']; ?>" class="btn btn-default"><i class="fa fa-arrow-circle-up"></i></button>
                                                                            <input name="upgrade_id" type="hidden" value="<?php echo $row['id']; ?>"/>
