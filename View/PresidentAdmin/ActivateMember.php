...
$result = $admin_president_model->get_all_deactivated_users();
                                                            ...
                                                            <tr data-expanded="true">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>  <form method="post" action="../../Controller/PresidentAdmin/ActionPerformed.php">
                                                                            ...
                                                                            <button name="activated" vlaue="<?php echo $row['id']; ?>" class="btn btn-default"><i class="fa fa-compass"></i></button>
                                                                            <input name="activated_id" type="hidden" value="<?php echo $row['id']; ?>"/>
