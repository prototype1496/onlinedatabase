...
$admin_president_model = new AdminPresidentModel();

$result = $admin_president_model->get_members();
                    ...
                    <div class="container ">
                        <div class="vd_top-nav vd_nav-width  ">
                            <div class="vd_panel-header">
                                <div class="logo">
                                    <a href="presidentAdminPanel.php"><img alt="logo" src="../../css/profilpiccss/img/logo.png"></a>
                                </div>
                                <!-- logo -->
                                                ...
                                                <li id="top-menu-profile" class="profile mega-li"> 
                                                    <a href="#" class="mega-link" data-action="click-trigger"> 
                                                        <span class="mega-image">
                                                            <img src="../../images/2.png" alt="example image">               
                                                        </span>
                                                        ...
                                                        <div class="child-menu"> 
                                                            <div class="content-list content-menu">
                                                                <ul class="list-wrapper pd-lr-10">
                                                                    ...
                                                                    <li> <a href="/OnlineDataBase/index.php"> <div class="menu-icon"><i class=" fa fa-sign-out"></i></div>  <div class="menu-text">Sign Out</div> </a> </li>
                                                                    <li class="line"></li>                
                ...
                <div class="container">
                    <div class="vd_navbar vd_nav-width vd_navbar-tabs-menu vd_navbar-left  ">
                        ...
                        <div class="vd_menu vd_navbar-bottom-widget">
                            <ul>
                                <li>
                                    <a href="/OnlineDataBase/index.php">
                    ...
                    <div class="vd_content-wrapper" style="min-height: 1059px;">
                        <div class="vd_container" style="min-height: 1059px;">
                            <div class="vd_content clearfix">
                                ...
                                <center> <div class="vd_title-section clearfix" style="width: 40rem;">  
                                        <!--Card content-->
                                        <div class="card-body px-lg-5 pt-0" style="width: 30rem; ">
                                            ...
                                            <!-- Form -->
                                            <form action="../../Controller/AddUser.php" method="POST" class="text-center" style="color: #757575;">


                                                <!-- Email -->
                                                <div class="md-form" >
                                                    <label>E-mail</label>
                                                    <input name="username" type="email" id="materialLoginFormEmail" class="form-control" placeholder="jondoe@example.com">
                                                ...
                                                <div class="md-form">
                                                    ...
                                                    <input name="password" type="password" id="materialLoginFormPassword" class="form-control" placeholder="Password">
                                                ...
                                                <!-- Sign in button -->
                                                <center><button class="btn btn-info btn-block my-4" type="submit" style="width: 10rem;" >Create</button></center>
