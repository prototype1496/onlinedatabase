...
include '../../../OnlineDataBase/controller/Session.php';
    ...
    $id =  $_GET['country'];
  $memeber_details =  $database_admin_model->getmember_details($id);
    $row  = mysqli_fetch_array($memeber_details);
  
  $memeber_careea_ocupation =  $database_admin_model->get_careea_ocupation($id);
 
  
  $memeber_education_details =  $database_admin_model->get_education_details($id);
  
    $memeber_cirtification_details =  $database_admin_model->get_certification_details($id);
          ...
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <div class="vd_info tr" style="margin-top: 2%"> <a class="btn vd_btn btn-xs vd_bg-yellow"> <i class="fa fa-check append-icon"></i> Approve </a> </div>      
